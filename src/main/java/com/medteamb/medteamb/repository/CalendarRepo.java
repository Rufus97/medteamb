...
public interface CalendarRepo extends JpaRepository<AppointmentSlot, Integer> {
    ...
    /*alue = "select sa.giorno from doctor d join slot_appuntamento sa
"on d.doctor_id  = sa.doctor_id " +
"group by sa.doctor_id  , sa.orario_finale , sa.giorno " +
"order by sa.giorno desc, sa.orario_finale  desc limit 2", nativ */
}
